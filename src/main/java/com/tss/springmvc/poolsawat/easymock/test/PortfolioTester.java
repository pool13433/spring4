package com.tss.springmvc.poolsawat.easymock.test;
...
import com.tss.springmvc.poolsawat.model.Portfolio;
import com.tss.springmvc.poolsawat.model.Stock;
...
public class PortfolioTester {
	...
	public boolean testMarketValue() {
		...
		EasyMock.expect(stockService.getPrice(microsoftStock)).andReturn(
				1000.00);
